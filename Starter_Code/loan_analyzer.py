...
print (f"The total of all loans is ${total_of_loans: .2f}.")

# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
# Print the average loan amount
average_loan = total_of_loans / number_of_loans
...
print(f"The Future Value is ${future_value: .2f}, and the Remaining Months on the loan is {remaining_months}.")
...
present_value = present_value(future_value=1000, remaining_months=12, annual_discount_rate=0.2) 
...
with open(csvpath, 'w', newline='') as csvfile:
    ...
    for value in inexpensive_loans:
